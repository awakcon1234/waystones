...
data remove storage pk:common temp.container[{components:{"minecraft:custom_data":{pk_data:{id:"waystone",from:"waystones",version:10b}}}}]
...
# Offhand
execute if items entity @s weapon.offhand player_head[custom_data~{pk_data:{id:"waystone",from:"waystones"}},!custom_data~{pk_data:{version:10b}}] at @s summon armor_stand run function pk_waystones:items/waystone/update/change/slot/offhand
