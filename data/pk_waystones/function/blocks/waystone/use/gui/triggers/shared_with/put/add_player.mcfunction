...
data modify storage pk:common temp.args set value {p1:"data modify storage pk:common temp.player.uuid set from storage pk:waystones database.players[{name:",p2:"}].uuid"}
data modify storage pk:common temp.args.v1 set from storage pk:common temp.player.name
