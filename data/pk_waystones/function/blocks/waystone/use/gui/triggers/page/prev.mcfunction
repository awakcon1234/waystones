#> pk_waystones:blocks/waystone/use/gui/triggers/page/prev
...
scoreboard players remove @e[type=marker,tag=pk.waystones.waystone.controller,distance=..0.1,limit=1] pk.waystones.page 1
