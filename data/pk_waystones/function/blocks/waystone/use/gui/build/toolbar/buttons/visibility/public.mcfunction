...
data modify storage pk:common temp.gui.item set value {id:"minecraft:leather_helmet",count:1,components:{"minecraft:custom_name":'[{"text":"Visibility: ","italic":false},{"text":"Public","color":"green","italic":false}]',"minecraft:dyed_color":{rgb:8439583,show_in_tooltip:false},"minecraft:attribute_modifiers":{modifiers:[],show_in_tooltip:false},"minecraft:trim":{material:"minecraft:emerald",pattern:"minecraft:sentry",show_in_tooltip:false},"minecraft:bundle_contents":[{id:"minecraft:stick",count:64}],"minecraft:custom_data":{pk_data:{gui:1b,from:"waystones",trigger:"visibility/change",trigger_params:{allowed:1b}}},"minecraft:custom_model_data":{strings:["pk_waystones:gui_visibility_public"]}},Slot:21b}
