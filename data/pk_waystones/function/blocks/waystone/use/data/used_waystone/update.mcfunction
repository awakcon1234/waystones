...
data modify storage pk:common temp.args set value {p1:"data modify storage pk:waystones database.waystones[{id:",p2:"}] set from storage pk:common temp.used_waystone"}
