...
execute unless data storage pk:common temp.waystone{name:'{"text":"Đá dịch chuyển"}'} run data modify storage pk:common temp.packages.dynamic_item.entity_data.Item.components."minecraft:custom_name" set from storage pk:common temp.waystone.name
