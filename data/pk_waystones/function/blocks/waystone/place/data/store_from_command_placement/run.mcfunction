...
data modify storage pk:common temp.waystone set value {variant:"andesite",visibility:"discover",discovered_by:[],shared_with:[],protected:0b,render_item:{id:"minecraft:grass_block"},name:'{"text":"Đá dịch chuyển"}',location:{dimension:"minecraft:overworld"}} 
# Id
