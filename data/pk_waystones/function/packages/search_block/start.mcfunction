...
# Prepare scores
execute store result score $distance pk.temp run data get storage pk:common temp.args.distance
...
execute store result score $packages.search_block.stop_at_first pk.temp run data get storage pk:common temp.args.stop_at_first
