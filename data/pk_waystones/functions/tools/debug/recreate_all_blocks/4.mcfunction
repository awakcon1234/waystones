...
# Check if the chunk of the block to recreate is loaded
...
# @continue If yes, recreate current block
...
# Continue process with next block to recreate, or stop it if there are no block anymore
