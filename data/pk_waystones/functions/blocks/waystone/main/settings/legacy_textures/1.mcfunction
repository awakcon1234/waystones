...
execute align xyz positioned ~ ~-1 ~ run function pk_waystones:blocks/waystone/place/components/skins/parts/middle/legacy_start with storage pk:common params