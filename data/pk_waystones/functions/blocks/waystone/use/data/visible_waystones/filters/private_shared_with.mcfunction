...
data modify storage pk:common params set value {p1:'data modify storage pk:common temp.filter.output append from storage pk:common temp.visible_waystones[{visibility:"private",shared_with:[{uuid:',p2:"}]}]"}
